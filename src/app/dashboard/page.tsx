    ...
    <>
      ...
      <main className="max-w-7xl mx-auto container-padding py-8 sm:py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
            ...
            <div className="card card-hover p-4 sm:p-6 bg-white border border-gray-200">
          ...
          {(userProfile.subscription_status === 'pro' || userProfile.subscription_status === 'lifetime') && (
            <>
              ...
              <div className="card p-6 sm:p-8 mb-6 sm:mb-8 bg-white border border-gray-200">
          ...
          {/* Account Info */}
          <div className="mt-8 sm:mt-12 card p-6 sm:p-8 bg-white border border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
